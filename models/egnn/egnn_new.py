...
class EGNN(nn.Module):
    def __init__(self, in_node_nf, in_edge_nf, hidden_nf, device='cpu', act_fn=nn.SiLU(), n_layers=3, attention=False,
                 ...
                 sin_embedding=False, normalization_factor=100, aggregation_method='sum', virtual_token_dim=None):
        ...
        self.virtual_token_dim = virtual_token_dim # 新增：虚拟 Token 的维度，如果为 None 则不使用虚拟 Token
