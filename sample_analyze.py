...
def main():
    ...
    if len(args.conditioning) == 0 and not eval_args.compute_nll:
        dataloaders, charge_scale = None, None
        print("Not retrieving dataloaders since not computing NLL.")
    else:
    ...
    if eval_args.compute_nll:
        print("Computing NLL for val and test sets.")
